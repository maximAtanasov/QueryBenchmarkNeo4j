...
public class IC9FixedLengthUniqueConstraintPersonIdIndexCreationDate extends BenchmarkTemplate {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(IC9FixedLengthUniqueConstraintPersonIdIndexCreationDate.class.getSimpleName())
                .forks(1)
                .build();
    ...
    public void prepare() {
        ...
        LOGGER.log(INFO, "DBHITS: {0}",
                profileDbHits(Queries.QUERY_29_USING_INDEX, 5,
                        new Pair<>(ParameterConstants.PERSON_ID, personIds),
                        new Pair<>(ParameterConstants.MAX_DATE, dates)));
    }

    @Benchmark
    public void query29UniqueConstraintPersonIdIndexCreationDate() {
        ...
        driver.session().readTransaction(transaction -> {
            var result = transaction.run(Queries.QUERY_29_USING_INDEX, params);
            return result.list();
        });
    }
