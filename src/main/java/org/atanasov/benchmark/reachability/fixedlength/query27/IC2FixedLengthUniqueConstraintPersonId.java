...
public class IC2FixedLengthUniqueConstraintPersonId extends BenchmarkTemplate {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(IC2FixedLengthUniqueConstraintPersonId.class.getSimpleName())
                .forks(1)
                .build();
    ...
    @Benchmark
    public void query27UniqueConstraintPersonId() {
