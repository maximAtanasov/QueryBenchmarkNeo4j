...
public class IC13ShortestPathNoIndexPersonId extends BenchmarkTemplate {

    private List<Long> personIds;

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(IC13ShortestPathNoIndexPersonId.class.getSimpleName())
                .forks(1)
                .build();
