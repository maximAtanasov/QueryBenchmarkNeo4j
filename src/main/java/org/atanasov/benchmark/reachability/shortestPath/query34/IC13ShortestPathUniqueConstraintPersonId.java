package org.atanasov.benchmark.reachability.shortestPath.query34;
...
public class IC13ShortestPathUniqueConstraintPersonId extends BenchmarkTemplate {

    private List<Long> personIds;

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(IC13ShortestPathUniqueConstraintPersonId.class.getSimpleName())
                .forks(1)
                .build();
    ...
    public void query34UniqueConstraint() {
        ...
        driver.session().readTransaction(transaction -> {
            var result = transaction.run(Queries.QUERY_34, params);
