package org.atanasov.benchmark.analytical.basic.aggregation.query39;
...
public class AverageMessageLengthIndex extends BenchmarkTemplate {

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(AverageMessageLengthIndex.class.getSimpleName())
                .forks(1)
                .build();
    ...
    public void prepare() {
        ...
        LOGGER.log(INFO, "DBHITS: {0}",
                profileDbHits(Queries.QUERY_39, 5));
    }

    @Benchmark
    public void query39Index() {
        driver.session().readTransaction(transaction -> {
            var result = transaction.run(Queries.QUERY_39);
